...
### Todos
- [ ] compiling LLVM to Scratch is wild. and in Rust?? bruh.
- [ ] Genshin x Minecraft crossover? wild. f mihoyo, f notch. love from Java.
- [x] llvm2scratch.rs is finally finished. this compiler is garbage. but I bet an even trashier ScratchArch will take its place.
- [x] PaimonMultipiler unlocks co-op and PvP. mihoyo at it again.
...
*Creative & Misc*
![Scratch](https://img.shields.io/badge/Scratch-FFAB19?style=flat-square&logo=scratch&logoColor=white)
![TurboWarp](https://img.shields.io/badge/TurboWarp-FF4C4C?style=flat-square&logo=scratch&logoColor=white)
